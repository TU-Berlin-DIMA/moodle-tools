...
def true_false(args):
    ...
    Returns:
        type: None.
    """
    generate_moodle_questions(TrueFalseQuestion.generate_xml, TrueFalseQuestion, **vars(args))
...
def multiple_true_false(args):
    ...
    Returns:
        type: None.
    """
    generate_moodle_questions(MultipleTrueFalseQuestion.generate_xml, MultipleTrueFalseQuestion, **vars(args))
...
def multiple_choice(args):
    ...
    generate_moodle_questions(
        SingleSelectionMultipleChoiceQuestion.generate_xml, SingleSelectionMultipleChoiceQuestion, **vars(args)
    )
...
def cloze(args):
    ...
    Returns:
        type: None.
    """
    generate_moodle_questions(ClozeQuestion.generate_xml, ClozeQuestion, **vars(args))
...
def numerical(args):
    ...
    Returns:
        type: None.
    """
    generate_moodle_questions(NumericalQuestion.generate_xml, NumericalQuestion, **vars(args))
...
def missing_words(args):
    ...
    Returns:
        type: None.
    """
    generate_moodle_questions(MissingWordsQuestion.generate_xml, MissingWordsQuestion, **vars(args))
...
def coderunner(args):
    ...
    Returns:
        type: None.
    """
    generate_moodle_questions(CoderunnerQuestionSQL.generate_xml, CoderunnerQuestionSQL, **vars(args))
